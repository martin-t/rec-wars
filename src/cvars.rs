...
pub struct Cvars {
    ...
    pub g_tank_hardpoint_machine_gun: Hardpoint,
    pub g_tank_hardpoint_machine_gun_x: f64,
    pub g_tank_hardpoint_machine_gun_y: f64,
    pub g_tank_hardpoint_railgun: Hardpoint,
    pub g_tank_hardpoint_railgun_x: f64,
    pub g_tank_hardpoint_railgun_y: f64,
    pub g_tank_hardpoint_cluster_bomb: Hardpoint,
    pub g_tank_hardpoint_cluster_bomb_x: f64,
    pub g_tank_hardpoint_cluster_bomb_y: f64,
    pub g_tank_hardpoint_rockets: Hardpoint,
    pub g_tank_hardpoint_rockets_x: f64,
    pub g_tank_hardpoint_rockets_y: f64,
    pub g_tank_hardpoint_homing_missile: Hardpoint,
    pub g_tank_hardpoint_homing_missile_x: f64,
    pub g_tank_hardpoint_homing_missile_y: f64,
    pub g_tank_hardpoint_guided_missile: Hardpoint,
    pub g_tank_hardpoint_guided_missile_x: f64,
    pub g_tank_hardpoint_guided_missile_y: f64,
    pub g_tank_hardpoint_bfg: Hardpoint,
    pub g_tank_hardpoint_bfg_x: f64,
    pub g_tank_hardpoint_bfg_y: f64,
...
impl Default for Cvars {
    fn default() -> Self {
        Self {
            ...
            g_tank_hardpoint_machine_gun: Hardpoint::Turret,
            g_tank_hardpoint_machine_gun_x: 0.0,
            g_tank_hardpoint_machine_gun_y: 0.0,
            g_tank_hardpoint_railgun: Hardpoint::Turret,
            g_tank_hardpoint_railgun_x: 0.0,
            g_tank_hardpoint_railgun_y: 0.0,
            g_tank_hardpoint_cluster_bomb: Hardpoint::Turret,
            g_tank_hardpoint_cluster_bomb_x: 0.0,
            g_tank_hardpoint_cluster_bomb_y: 0.0,
            g_tank_hardpoint_rockets: Hardpoint::Turret,
            g_tank_hardpoint_rockets_x: 0.0,
            g_tank_hardpoint_rockets_y: 0.0,
            g_tank_hardpoint_homing_missile: Hardpoint::Chassis,
            g_tank_hardpoint_homing_missile_x: 0.0,
            g_tank_hardpoint_homing_missile_y: -15.0,
            g_tank_hardpoint_guided_missile: Hardpoint::Chassis,
            g_tank_hardpoint_guided_missile_x: 0.0,
            g_tank_hardpoint_guided_missile_y: -15.0,
            g_tank_hardpoint_bfg: Hardpoint::Turret,
            g_tank_hardpoint_bfg_x: 0.0,
            g_tank_hardpoint_bfg_y: 0.0,
