        ...
        match vehicle {
            ...
            Vehicle::Hovercraft => match weapon {
                ...
                Weapon::Bfg => (
                    ...
                    Vec2f::new(self.g_hardpoint_hovercraft_bfg_x, self.g_hardpoint_hovercraft_bfg_y),
                ),
...
impl Default for Cvars {
    fn default() -> Self {
        Self {
            ...
            g_hardpoint_hovercraft_homing_missile_y: -15.0,
            g_hardpoint_hovercraft_guided_missile: Hardpoint::Chassis,
            g_hardpoint_hovercraft_guided_missile_x: 0.0,
            g_hardpoint_hovercraft_guided_missile_y: -15.0,
            g_hardpoint_hovercraft_bfg: Hardpoint::Turret,
            g_hardpoint_hovercraft_bfg_x: 35.0,
            g_hardpoint_hovercraft_bfg_y: 0.0,

            g_hardpoint_hummer_machine_gun: Hardpoint::Turret,
            g_hardpoint_hummer_machine_gun_x: 12.0,
            g_hardpoint_hummer_machine_gun_y: -5.0,
            g_hardpoint_hummer_railgun: Hardpoint::Turret,
            g_hardpoint_hummer_railgun_x: 35.0,
            g_hardpoint_hummer_railgun_y: 0.0,
            g_hardpoint_hummer_cluster_bomb: Hardpoint::Turret,
            g_hardpoint_hummer_cluster_bomb_x: 35.0,
            ...
            g_hardpoint_hummer_homing_missile_y: -15.0,
            g_hardpoint_hummer_guided_missile: Hardpoint::Chassis,
            g_hardpoint_hummer_guided_missile_x: 0.0,
            g_hardpoint_hummer_guided_missile_y: -15.0,
            g_hardpoint_hummer_bfg: Hardpoint::Turret,
            g_hardpoint_hummer_bfg_x: 35.0,
            g_hardpoint_hummer_bfg_y: 0.0,
